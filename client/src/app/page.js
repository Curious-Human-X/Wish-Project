  ...
  return (
    <main className="h-screen w-full flex flex-col md:flex-row bg-pink-50 overflow-hidden">
      <div className="w-full md:w-1/3 flex items-center justify-center p-10 z-20">
        <div className="text-center md:text-left"><h1 className="text-4xl md:text-6xl font-bold text-pink-600 mb-4">Happy Birthday!</h1><p className="text-gray-500 text-lg">Make a wish and hold the spacebar (or touch) to blow out the candles.</p></div>
      </div>
